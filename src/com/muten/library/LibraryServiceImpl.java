...
public class LibraryServiceImpl implements LibraryService {
    ...
    private static String today = sdf.format(date);
    ...
    public void borrowBook() throws InputMismatchException, NullPointerException {
        ...
        for (Integer key : bookList.keySet()) {
            if (bookList.get(key).getBorrowDate() == null || bookList.get(key).getReturnDate() != null) {
                System.out.println(bookList.get(key));
            }
        }
    ...
    @Override
    public void returnBook() throws InputMismatchException {
